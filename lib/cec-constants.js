 ...
 * copies from @senzil/cec-monitor repository on 2021-01-28
 * With modifications from @Garfonso
 */
'use strict';
...
for (const section in data) {
    ...
    for (const key in data[section]) {
        // eslint warning not useful necessary for objects with fixed contents
