 ...
 * @property {(data: object) => unknown} [parse] - parse CEC event to state
 ...
 * @property {(value: unknown, device: object, cec: object, log: object) => Promise<void>} [command] - async function that is called if state is written -> i.e. control devices.
 * @property {boolean} [isGlobal] - belongs to the global device
 * @property {"string" | "number" | "boolean" | "object" | "array" | "mixed" | "file"} type - ioBroker type, i.e. "string", "number", "boolean", ...
