...
const stateDefinitions = {
    ...
    systemAudio: {
        ...
        command: async function(_value, _device, cec) {
            ...
            return cec.sendCommand(cec.getActiveSource(), CEC.LogicalAddress.AUDIOSYSTEM, CEC.Opcode.SYSTEM_AUDIO_MODE_REQUEST, CECMonitor.EVENTS.SYSTEM_AUDIO_MODE_STATUS, cec.getActiveSourcePhysical());
        },
