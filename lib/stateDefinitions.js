 ...
 * @property {string} [pollOpCode]          - opcode used for polling, will also create a poll-button.
 * @property {string} [pollArgument]        - argument for pollOpCode, if polling is more complex.
 * @property {string} [pollTarget]          - if polling targets a different logical address (especially for global states)
 ...
 * @property {Array<string>} [valueList]    - valuelist in object.common
 */
...
const stateDefinitions = {
    ...
    'osd-message': {
        ...
        command: async function (value, _device, cec) {
            if (value) {
                await cec.SendMessage(null, CEC.LogicalAddress.TV, CEC.Opcode.SET_OSD_STRING, value);
            }
        },
        isGlobal: true
    },
    'osd-message-clear': {
        ...
        role: 'button',
        command: async function (_value, _device, cec) {
            await cec.SendMessage(null, CEC.LogicalAddress.TV, CEC.Opcode.SET_OSD_STRING, '');
        },
        isGlobal: true
    },
    'createButtons': {
