...
class CECMonitor extends events.EventEmitter {
    ...
    constructor(OSDName, options) {
        ...
        this.params = ['-t', this.type, '-o', this.OSDName, '-d', '31', '-p', (options.hdmiPort || 1).toString(), (this.comPort).toString()];
     ...
     * @returns {null|import('node:child_process').ChildProcessWithoutNullStreams}
     * @private
     */
    _initCecClient() {
